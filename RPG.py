...
print("\n       Welcome accommodation, to the game world: “Fantasia”. I am your Game Threading System, Q. "
          "\nIn order to travel back to your universe, you must finish all the missions with the main character:Sir Charles,and defeat the finale boss. "
...
player_choices = int(input("\nPlease choose wisely my accommodation(enter number):  "))
...
while not guessed and player_attempts >0:
    password = input("\nPlease think wisely my accommodation.(type your answer here. All in lower case):  ")
